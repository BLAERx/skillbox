...
#
#
# В текущем модуле (lesson_006/python_snippets/04_practice_1.py) реализовать логику работы с пользователем:
#  начало игры,
...
from nim_engine_1 import put_stones, get_bunches, is_gameover, take_from_bunch
